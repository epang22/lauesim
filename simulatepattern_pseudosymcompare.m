%SIMULATEPATTERN_PSUEDOSYMCOMPARE
% Compare patterns for 2 pseudosymmetry variants on same plot
...
minFplot = 10;   % only plot spot if |F| greater than this value
...
minFlabel = 10;          % label hkl and |F| only if |F| greater than this value
...
% Calculate UB for pseudosymmetry variant
...
spots1 = spots;     % coordinates of diffracted spots on detector (pseudosym variant)
